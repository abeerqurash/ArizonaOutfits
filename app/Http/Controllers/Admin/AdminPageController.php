...
class AdminPageController extends AdminController
{
    ...
    public function create(): View
    {
        return view('admin.pages.create', [
            'page' => new Page(['render_mode' => 'editor']),
    ...
    public function store(
        ...
        // New admin ownership. Legacy user columns are deliberately not reused.
        $data['creator_admin_id'] = $admin->id;
        $data['editor_admin_id'] = $admin->id;
    ...
    public function edit(Page $page): View
    {
        ...
        return view('admin.pages.edit', compact('page', 'customTemplates'));
    }
    ...
    private function validated(Request $request, ?Page $page = null): array
    {
        return $request->validate([
            ...
            'blade_template' => [
                'nullable',
                'required_if:render_mode,custom',
                'string',
                Rule::in(array_keys($this->customTemplates())),
            ],
            'content' => [
                'nullable',
                'required_if:render_mode,editor',
                'string',
                'max:200000',
            ],
            'status' => ['required', 'in:draft,published'],
            'template' => ['required', 'in:default,wide,minimal'],
    ...
    private function slug(
        ...
        while (
            Page::query()
                ...
                ->when(
                    $page,
                    fn ($query) => $query->where('id', '!=', $page->id)
                )
                ->exists()
        ) {
