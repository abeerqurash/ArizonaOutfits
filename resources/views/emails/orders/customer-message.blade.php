                ...
                <table role="presentation" width="100%" cellspacing="0" cellpadding="0" border="0" style="max-width:620px;background:#ffffff;border:1px solid #e5e5e5;border-radius:10px;overflow:hidden;">
                    ...
                    <tr>
                        <td style="padding:30px;">
                            ...
                            <div style="margin:18px 0 24px;padding:20px;background:#f7f7f7;border-left:4px solid #111111;font-size:15px;line-height:1.8;color:#333333;">
                                {!! nl2br(e($messageText)) !!}
                            </div>
                            ...
                            <p style="margin:0 0 8px;font-size:14px;line-height:1.7;color:#555555;">
                                If you have any questions about this message or your order, please reply to this email or contact Arizona Outfits support.
                            </p>

                            <p style="margin:18px 0 0;font-size:14px;line-height:1.7;color:#444444;">
                                Kind regards,<br>
                    ...
                    <tr>
                        <td style="padding:20px 30px;background:#fafafa;border-top:1px solid #eeeeee;text-align:center;font-size:12px;line-height:1.6;color:#777777;">
                            This message was sent by Arizona Outfits regarding your order.<br>
