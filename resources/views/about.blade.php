...
@section('title', 'About Ideostream — The Story Behind What We Do') {{-- or $title if passed from controller --}}
@section('meta_description', 'Ideostream was built by real people tired of scattered information. We cover tech, health, finance, culture and everything in between — honestly and without the fluff.')
...
<div class="page-wrapper">
    ...
    <div class="home-hero">
        ...
        <div class="content-wrapper">
            <div class="content-1 content">
                <p class="fs-12 text-color-white text-uppercase letter-space-4px">About</p>
            </div>
            ...
            <div class="content-3 content">
                <h1 class="fs-78 text-color-white">Passionate About <br> Every Topic</h1>
            ...
            <div class="home content">
                <div class="header-subtitle">
                    <div class="subtitle fs-12 text-uppercase text-color-white letter-space-4px">What we do</div>
    ...
    <div class="services no-top-padding">
            ...
            <div class="services-grid">
                    ...
                    <div class="service-card">
                        <div class="featured-card-info">
                            <div class="card-description">
                                <h3 class="fs-12 text-uppercase letter-space-4px text-color-dark">AI & Machine Learning</h3>
                                <p class="text-color-body fs-16">Stop believing every AI headline. Here is what is genuinely transforming industries and what is cleverly marketed fiction right now.</p>
                            </div>
                        </div>
                    </div>
                </div>
                <div class="service-parent">
                    ...
                    <div class="service-card">
                        <div class="featured-card-info">
                            <div class="card-description">
                                <h3 class="fs-12 text-uppercase letter-space-4px text-color-dark">Cybersecurity & Data Privacy</h3>
                                <p class="text-color-body fs-16">Hackers are smarter, attacks are faster, and most people are still making the same costly security mistakes daily.</p>
                            </div>
                        </div>
                    </div>
                </div>
                <div class="service-parent">
                    ...
                    <div class="service-card">
                        <div class="featured-card-info">
                            <div class="card-description">
                                <h3 class="fs-12 text-uppercase letter-space-4px text-color-dark">FinTech & Digital Banking</h3>
                                <p class="text-color-body fs-16">Digital-first banking is no longer a trend — it is the new standard leaving legacy institutions scrambling to catch up.</p>
                            </div>
                        </div>
                    </div>
                </div>
                <div class="service-parent">
                    ...
                    <div class="service-card">
                        <div class="featured-card-info">
                            <div class="card-description">
                                <h3 class="fs-12 text-uppercase letter-space-4px text-color-dark">Climate Tech & Green Energy</h3>
                                <p class="text-color-body fs-16">Record investments and EV adoption are promising — yet experts warn the pace remains dangerously short of net-zero targets.</p>
                            </div>
                        </div>
                    </div>
                </div>
                <div class="service-parent">
                    ...
                    <div class="service-card">
                        <div class="featured-card-info">
                            <div class="card-description">
                                <h3 class="fs-12 text-uppercase letter-space-4px text-color-dark">Health Tech & Digital Wellness</h3>
                                <p class="text-color-body fs-16">Smartwatches now catch conditions doctors miss. Discover how digital health tools are shifting medicine from reactive to genuinely preventative care.</p>
                            </div>
                        </div>
                    </div>
                </div>
                <div class="service-parent">
                    ...
                    <div class="service-card">
                        <div class="featured-card-info">
                            <div class="card-description">
                                <h3 class="fs-12 text-uppercase letter-space-4px text-color-dark">Cryptocurrency & Web3</h3>
                                <p class="text-color-body fs-16">Regulation, institutional adoption, and real-world utility are reshaping crypto far beyond the speculation and chaos of previous years.</p>
                            </div>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="categories-list">
                            <div class="category category-item-1">
                                <div class="card">
                                    ...
                                    <a href="/services/web-development" class="card-link">
                            ...
                            <div class="category category-item text-uppercase">
                                <div class="card">
                                    <div class="card-circle"></div>
                                    <a href="/services/wordpress-development" class="card-link">
                            ...
                            <div class="category category-item-3">
                                <div class="card">
                                    <div class="card-circle"></div>
                                    <a href="/services/laravel-development" class="card-link">
