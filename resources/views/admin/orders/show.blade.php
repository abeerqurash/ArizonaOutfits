        ...
        <form
            ...
            <div class="premium-form-group">
                ...
                <div class="input-with-action">
                    <input
                        ...
                        value="{{ $trackingNumber ?: 'Not generated' }}"
                        readonly
                        aria-readonly="true">
            ...
            <div class="premium-form-group">
                ...
                <input
                    ...
                    id="courier_provider"
                    class="premium-input"
                    value="{{ old('courier_provider', $courierProvider) }}"
                    maxlength="100"
            ...
            <div class="premium-form-group">
                ...
                <input
                    ...
                    id="courier"
                    class="premium-input"
                    value="{{ old('courier', $courierTrackingNumber) }}"
                    maxlength="255"
        ...
        <section class="premium-panel sidebar-summary-panel">
            ...
            <div class="courier-shipment-summary">
                <div class="courier-summary-row">
                    ...
                    <strong>{{ $latestShipment->courier_provider ?: ($courierProvider ?: 'Not specified') }}</strong>
                </div>

                <div class="courier-summary-row">
                    <span>Courier tracking number</span>
                    <strong class="breakable-value">
                        {{ $latestShipment->courier_tracking_number ?: ($courierTrackingNumber ?: 'Not provided') }}
                    </strong>
                </div>
                ...
                <div class="courier-summary-row">
                    ...
                    <strong>
                        {{ ucwords(str_replace('_', ' ', $shipmentTrackingMode)) }}
                    </strong>
                </div>
                ...
                <div class="courier-summary-row">
                    ...
                    <strong class="breakable-value">
                        {{ $shipmentProviderStatus ?: 'No provider status yet' }}
                    </strong>
                </div>
            ...
            <div class="shipment-events-block">
                <div class="shipment-events-heading">
                    <div>
                        ...
                        <strong>{{ $shipmentTrackingEvents->count() }} event{{ $shipmentTrackingEvents->count() === 1 ? '' : 's' }}</strong>
                    </div>

                    <small>Admin only</small>
                </div>

                @forelse ($shipmentTrackingEvents as $trackingEvent)
                <div class="shipment-event-item">
                    ...
                    <div class="shipment-event-content">
                        <div class="shipment-event-topline">
                            <strong>
                                {{ $trackingEvent->provider_status ?: 'Courier event' }}
                            </strong>

                            <span>
                                {{ ($trackingEvent->event_time ?? $trackingEvent->received_at)
                        ...
                        <div class="shipment-event-meta">
                            <span>
                                ArizonaOutfits:
                                <strong>
                                    {{ $trackingEvent->normalized_status
                            ...
                            <span>
                                Location:
                                <strong>{{ $trackingEvent->location }}</strong>
                            </span>
                            @endif
                        </div>

                        @if ($trackingEvent->description)
                        <p>{{ $trackingEvent->description }}</p>
                        @endif
                    </div>
                </div>
                @empty
            ...
            @elseif ($courierProvider || $courierTrackingNumber)
            <div class="courier-shipment-summary">
                <div class="courier-summary-row">
                    <span>Courier provider</span>
                    <strong>{{ $courierProvider ?: 'Not specified' }}</strong>
                </div>

                <div class="courier-summary-row">
                    <span>Courier tracking number</span>
                    <strong class="breakable-value">
                        {{ $courierTrackingNumber ?: 'Not provided' }}
                    </strong>
                </div>
            </div>
            @else
...
<div
    ...
    <div
        ...
        <p class="email-customer-recipient">
            Send a message to
            <strong>{{ $customerEmail ?: 'this customer' }}</strong>
        </p>

        <form
            action="{{ route('admin.orders.email-customer', $order) }}"
            method="POST"
            ...
            <div class="email-customer-fields">
                ...
                <div class="email-customer-field">
                    ...
                    <textarea
                        ...
                        maxlength="10000"
                        required
                        placeholder="Write your message to the customer...">{{ old('message') }}</textarea>
                </div>
            </div>
    ...
    <div
        ...
        @else
            ...
            <h2 id="orderFeedbackTitle">
                {{ $errors->any() ? 'Please check the form' : 'Error' }}
            </h2>
