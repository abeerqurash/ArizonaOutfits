            ...
            <div class="mega-menu-wrapper">
                ...
                <div class="categories-wrapper">
                    <div class="categories-description">
                        ...
                        <a href="/category" class="btn-style-2 fs-12 text-color-white justify-self-end">
                            <div class="button-text text-uppercase letter-space-3px">View All Categories</div>
                        </a>
                    </div>
