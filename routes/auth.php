...
Route::middleware('guest')->group(function () {
    ...
    Route::post('login', [AuthenticatedSessionController::class, 'store'])->middleware('throttle:authentication');
...
Route::middleware('auth')->group(function () {
    ...
    Route::post('confirm-password', [ConfirmablePasswordController::class, 'store'])->middleware('throttle:authentication');
    Route::put('password', [PasswordController::class, 'update'])->middleware('throttle:authentication')->name('password.update');
